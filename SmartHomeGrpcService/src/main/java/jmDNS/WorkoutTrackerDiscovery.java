...
public class WorkoutTrackerDiscovery {

	//option 1
		private static class WorkoutTrackerListener implements ServiceListener{
		...
		public static ServiceInfo run(String workoutTracker_service) {
